...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
	...
	public void setPanel(String name) {
		...
		mFrame.contentPanel.add(mPanel,name);
		mFrame.showCard(name);
	}
	...
	// controller.GameEngine Constructor
	public GameEngine() {
	...
	// Create Game Function
	public static void createGame(GameEngine game, int framerate, String name) {
		viewName = name;
		// Initialise Game
		game.init();
	...
	// The controller.GameEngine main Panel
	...
	public void drawBoldText(double x, double y, String s, Font font, int size, Color c) {
		// Draw text on the screen
		changeColor(c);
